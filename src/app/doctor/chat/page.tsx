...
export default function DoctorChatPage() {
  ...
  if (isLoadingRooms) {
    return (
      <div className="space-y-6">
        <PageHeader title="メッセージ" description="法人とのメッセージをやり取りできます" />
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-small text-ink-muted mt-2">
              求人に応募するか、スカウトに返信するとメッセージが開始されます
            </p>
          </CardContent>
        </Card>
      </div>
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="メッセージ"
        description="法人とのメッセージをやり取りできます"
        actions={
          <Button
            variant="outline"
            size="small"
            ...
            {filteredRooms.map((room) => (
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 rounded bg-accent-soft flex items-center justify-center flex-shrink-0">
            ...
            <>
              ...
              <div className="p-4 border-b border-border">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded bg-accent-soft flex items-center justify-center">
                    <Building2 className="w-5 h-5 text-accent" />
                  </div>
                  <div>
